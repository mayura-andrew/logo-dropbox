...
const UserForm = () => {
  return (
    ...
    <h2 className="text-lg font-bold text-white items-center">Tell us about yourself 🚀</h2>  <form className="bg-black shadow-md rounded  px-4 sm:px-8 pt-6 pb-8 mb-4">
    <div className="mb-4">
